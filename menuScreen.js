class MenuScreen extends Screen {
    constructor() {
        ...
        this.Mbut = new Array();
        this.Mbut.push(new Button(150, 150, 600, 55, "PLAY" , "rgba(70,100,168,255)" , "rgba(128,128,128,255)" , "rgba(90,120,188,255)", "rgba(255,255,255,225", 45));
        this.Mbut.push(new Button(150, 300, 600, 55, "OPTIONS" , "rgba(70,100,168,255)" , "rgba(128,128,128,255)" , "rgba(90,120,188,255)" , "rgba(255,255,255,225", 45));
    }
